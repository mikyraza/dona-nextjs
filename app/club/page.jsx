  ...
  return (
    <main className="club-main">
      {/* Section 1: Hero */}
        ...
        {/* Section 1.5: Offres & Espace Membre */}
        <section className="club-services" style={{ padding: "4rem 0", background: "var(--club-surface-alt, #FAF9F6)", borderBottom: "1px solid var(--club-border, #E5E7EB)" }}>
